 ...
 */
package com.harman.pdfviewpager.library;
...
import com.harman.pdfviewpager.library.remote.DownloadFile;
import com.harman.pdfviewpager.library.remote.DownloadFileUrlConnectionImpl;
import com.harman.pdfviewpager.library.util.FileUtil;
...
public class RemotePDFViewPager extends ViewPager implements DownloadFile.Listener {
    ...
    private void init(DownloadFile downloadFile, String pdfUrl, String customFileName) {
        setDownloader(downloadFile);
        downloadFile.download(pdfUrl, new File(context.getCacheDir(), customFileName).getAbsolutePath());
    }
